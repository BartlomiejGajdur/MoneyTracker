...
public:
    Loan(const std::string& description, double moneyToPay, Date paymentDate, const int numberOfInstallments) : Obligations(moneyToPay,paymentDate), description_(description) ,numberOfInstallments_ (numberOfInstallments) {};
    ~Loan(){};  
